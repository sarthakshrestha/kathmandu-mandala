...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#FFF9EE]  pt-6 lg:pt-10 lg:pb-8 pb-6 max-sm:px-8 ">
      ...
      <div className="max-w-5xl mx-auto mt-4 mb-1 items-end flex justify-end ">
        <a
      ...
      {/* Divider */}
      <div className="max-w-5xl mx-auto  mb-6 border-t border-gray-300"></div>
      {/* Bottom Section */}
