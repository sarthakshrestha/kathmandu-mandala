        ...
        <div className="px-6 pb-4">
          <DialogDescription asChild>
            <div className="text-[#23233B] text-base mb-4">
              <p className="mb-2">To apply for your Nepal Visa:</p>
              <ol className="list-decimal list-inside space-y-1 font-links">
                <li>
                  <span className="font-semibold">Download the Visa Form</span>
                </li>
                <li>Fill it out on your device or by hand</li>
                <li>
                  Send Via Whatsapp to{" "}
                  <span className="font-semibold">+977 98123456789</span>
                </li>
              </ol>
            </div>
          </DialogDescription>
